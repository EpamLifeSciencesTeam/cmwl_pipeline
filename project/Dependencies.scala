...
object Dependencies {
  ...
  val liquibaseLogger = "org.apache.logging.log4j" % "log4j-liquibase" % Version.liquibaseLogger
  ...
  lazy val dbDependencies = Seq(slick, hikariCP, postgresql, liquibase, yaml, liquibaseLogger)
